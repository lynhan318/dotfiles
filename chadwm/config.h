...
static const char *fonts[]          = {"JetBrainsMono Nerd Font:style:medium:size=12" ,"JetBrainsMono Nerd Font:style:medium:size=8" };
...
static const char* night[] = { "redshift","-P","-O", "4000" , NULL };
...
static const Rule rules[] = {
    ...
    { "1password",                          NULL,       NULL,       1 << 8,       1,           1,           -1 },
    { "1Password",                          NULL,       NULL,       1 << 8,       1,           1,           -1 },
    { "telegram-desktop",                   NULL,       NULL,       1 << 8,       1,           1,           -1 },
    { "blueman-manager",                    NULL,       NULL,       1 << 8,       1,           1,           -1 },
    { "org.gnome.Nautilus",                 NULL,       NULL,       1 << 8,       1,           1,           -1 },
    { "Emulator",                           NULL,       NULL,       1 << 8,       1,           1,           -1 },  
    { "virt-manager",                       NULL,       NULL,       1 << 8,       1,           1,           -1 },
};
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_o,       spawn,          SHCMD("nautilus")},
